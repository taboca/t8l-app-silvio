...
var app =  {
	...
	render : function() {
		...
		if(this.tweetQueue.length<1) { 
			...
			setTimeout( function () { self.render() }, 30222);
		} 
	},
	...
	__feedUpdated : function() {
        this.tweetQueue.push( '<div style="display:none"><h3></h3><div class="desc">agenda</div><div class="descFull" style="display:none">frame</div><img src="../grade/index.html" /></div>' );
        this.tweetQueue.push( '<div style="display:none"><h3></h3><div class="desc">midia</div><div class="descFull" style="display:none">frame</div><img src="../thumbs/fisl.html" /></div>' );
		this.render();
	}
}
